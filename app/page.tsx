    ...
    >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8 sm:space-y-12 pb-32">
        ...
        <section className="space-y-6">
          ...
          >
            <div
              className={`p-5 sm:p-7 rounded-[2rem] border transition-all hover:scale-[1.02] sm:col-span-2 lg:col-span-1 shadow-sm relative overflow-hidden group ${isDark ? "glass-dark border-white/5" : "glass border-slate-200"}`}
            >
              ...
              <div className="flex items-baseline gap-1 sm:gap-1.5 overflow-hidden">
                ...
                <p
                  className={`text-2xl sm:text-3xl font-black ${isDark ? "text-white" : "text-slate-900"} tracking-tighter truncate`}
                >
            ...
            <div
              className={`p-5 sm:p-7 rounded-[2rem] border transition-all hover:scale-[1.02] shadow-sm relative overflow-hidden group ${isDark ? "glass-dark border-white/5" : "glass border-slate-200"}`}
            >
              <p className="text-[9px] font-black text-green-500 uppercase tracking-[0.2em] mb-3">
                Pemasukan
              </p>
              <div className="flex items-baseline gap-1 overflow-hidden">
                ...
                <p className="text-2xl sm:text-3xl font-black text-green-600 tracking-tighter truncate">
            ...
            <div
              className={`p-5 sm:p-7 rounded-[2rem] border transition-all hover:scale-[1.02] shadow-sm relative overflow-hidden group ${isDark ? "glass-dark border-white/5" : "glass border-slate-200"}`}
            >
              <p className="text-[9px] font-black text-red-500 uppercase tracking-[0.2em] mb-3">
                Pengeluaran
              </p>
              <div className="flex items-baseline gap-1 overflow-hidden">
                <span className="text-[10px] sm:text-xs font-black text-red-600">
                  IDR
                </span>
                <p className="text-2xl sm:text-3xl font-black text-red-600 tracking-tighter truncate">
            ...
            <div
              id="tour-saving"
              className={`p-5 sm:p-7 rounded-[2rem] border transition-all hover:scale-[1.02] shadow-sm relative overflow-hidden group ${isDark ? "glass-dark border-blue-900/20" : "bg-blue-50/50 border-blue-100"}`}
            >
              <p className="text-[9px] font-black text-blue-500 uppercase tracking-[0.2em] mb-3">
                Tabungan
              </p>
              <div className="flex items-baseline gap-1 overflow-hidden">
                <span className="text-[10px] sm:text-xs font-black text-blue-500">
                  IDR
                </span>
                <p
                  className={`text-2xl sm:text-3xl font-black tracking-tighter truncate ${isDark ? "text-blue-400" : "text-blue-600"}`}
                >
                  {stats.saving.toLocaleString("id-ID")}
                </p>
              </div>
            </div>
            <div
              className={`p-5 sm:p-7 rounded-[2rem] border transition-all hover:scale-[1.02] shadow-sm relative overflow-hidden group ${isDark ? "glass-dark border-cyan-900/20" : "bg-cyan-50/50 border-cyan-100"}`}
            >
              <p className="text-[9px] font-black text-cyan-500 uppercase tracking-[0.2em] mb-3">
                Tingkat Tabungan
              </p>
              <p className="text-2xl sm:text-3xl font-black text-cyan-600 tracking-tighter">
        ...
        <section className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          >
            ...
            <h3 className="text-[10px] sm:text-xs font-black uppercase tracking-widest mb-0.5 sm:mb-1">
              Dompet
            </h3>
            <p className="text-[8px] sm:text-[10px] font-bold opacity-50 uppercase tracking-widest truncate">
              {wallets.length} Akun
            </p>
          </Link>
          ...
          <div id="tour-ledger" className="lg:col-span-12 space-y-6">
            ...
            >
              {loading ? (
                ...
                <div className="p-12 text-center opacity-50 italic text-sm">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left">
                    <thead>
                      ...
                      >
                        <th className="p-4 sm:p-6 text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
                          Garis Waktu
                        </th>
                        <th className="p-4 sm:p-6 text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
                          Aktivitas
                        </th>
                        <th className="p-4 sm:p-6 text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-right">
                          Nilai
                        </th>
                      </tr>
                    </thead>
                    ...
                    >
                      {transactions.slice(0, 5).map((t) => (
                        ...
                        >
                          ...
                          <td className="p-4 sm:p-6">
                            <div className="text-xs sm:text-sm font-bold opacity-80 line-clamp-1">
                              {t.keterangan}
                            </div>
                            <div className="text-[8px] sm:text-[9px] font-black opacity-50 uppercase tracking-widest">
                              {t.kategori}
                            </div>
                          </td>
                          <td
                            className={`p-4 sm:p-6 text-right font-black tracking-tighter text-xs sm:text-base ${t.income > 0 ? "text-green-500" : t.saving > 0 ? "text-blue-500" : "text-red-500"}`}
                          >
                            {t.income > 0 && "+"}
