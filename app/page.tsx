...
function DashboardContent({
  ...
  return (
    ...
    >
        ...
        <div className="max-w-[1600px] mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <button
              ...
              className={`w-10 h-10 rounded-2xl flex items-center justify-center transition-all ${isDark ? "bg-red-500/10 text-red-500 border border-red-500/20 hover:bg-red-500/20" : "bg-red-50 text-red-600 border border-red-100 hover:bg-red-100 shadow-sm"} hover:scale-105 active:scale-95`}
              title="Keluar"
            >
              <LogOut size={20} />
            </button>
      ...
      {/* Period Selection */}
      <div className="px-6 overflow-x-auto no-scrollbar relative z-20">
        <div className="flex gap-2 max-w-[1600px] mx-auto">
          {["Hari", "Minggu", "Bulan", "Tahun", "Semua"].map((period: any) => (
            <button
              key={period}
              onClick={() => setActivePeriod(period)}
              className={`px-6 py-2.5 rounded-2xl text-xs font-bold transition-all flex-shrink-0 ${
                activePeriod === period
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-10 py-8 sm:py-12 space-y-8 sm:space-y-12 pb-32">
        ...
        <section className="px-1">
          <div className="bg-gradient-to-br from-indigo-600 via-violet-600 to-indigo-800 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-2xl shadow-indigo-600/20">
            {/* Background pattern */}
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <div className="flex items-center gap-4 mb-4">
                <h2 className="text-5xl sm:text-7xl font-black tracking-tight">
                  <span className="opacity-50 text-2xl sm:text-4xl mt-2 font-black mr-2">
                    Rp
                  </span>
                  {isBalanceMasked
                    ? " •••.•••,••"
              ...
              <div className="grid grid-cols-2 gap-4 w-full">
                <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-3xl p-4 flex flex-col items-start text-left">
        ...
        <section className="px-1">
          <div
            className={`p-8 rounded-[2.5rem] border transition-all ${isDark ? "bg-slate-900 border-white/5 shadow-2xl shadow-black/40" : "bg-white border-slate-100 shadow-xl shadow-slate-200/50"}`}
          >
                  ...
                  <div className="space-y-4">
                    {group.items.map((tx: any) => {
                      return (
                        <div
                          key={tx.id}
                          className={`p-5 rounded-[2rem] border flex items-center gap-4 transition-all hover:translate-y-[-2px] active:scale-[0.98] cursor-pointer group ${isDark ? "bg-slate-900 border-white/5 shadow-xl shadow-black/20" : "bg-white border-slate-100 shadow-sm hover:shadow-md"}`}
                        >
