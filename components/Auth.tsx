    ...
    try {
      if (mode === "forgot") {
        ...
        if (process.env.NODE_ENV === "development") {
          console.log(
            "🔐 DEVELOPMENT MODE: Password reset requested for:",
            email,
          );
          console.log("📧 Check your email inbox (including spam folder)");
          console.log(
            "⚠️ If email not received, check Supabase Dashboard → Auth → Email Templates",
          );
        }
      } else if (mode === "signup") {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        {message && (
          <div
            className={`mb-6 p-4 rounded-2xl text-xs font-bold uppercase tracking-wider text-center border animate-in fade-in slide-in-from-top-4 duration-300 ${
              message.type === "error"
                ? isDark
            ...
            <>
              ...
              >
                {mode === "signup" ? (
                  ...
                  <>
                    Belum punya akses?{" "}
                    <span className="underline">Buat Akun Baru</span>
                  </>
                )}
              </button>
            </>
