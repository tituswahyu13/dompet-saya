...
export default function PWAInstallPrompt({ isDark }: { isDark: boolean }) {
  ...
  return (
    <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-[100] w-[90%] max-w-md animate-in slide-in-from-bottom-10 duration-500">
      ...
      >
        <div className="w-14 h-14 bg-gradient-to-tr from-indigo-600 to-violet-600 rounded-2xl flex-shrink-0 flex items-center justify-center shadow-lg shadow-indigo-600/20">
          <img
            src="/DompetSayaIcon.svg"
            alt="Logo"
        ...
        <div className="flex flex-col gap-2">
          <button
            ...
            className="px-4 py-2 bg-indigo-600 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-600/30"
          >
            Instal
          </button>
          <button
