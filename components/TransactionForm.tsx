...
const CATEGORIES = {
  ...
  outcome: ['Kebutuhan Pokok', 'Lifestyle (Makan/Jajan)', 'Personal Care', 'Transport', 'Cicilan', 'Lainnya'],
            ...
            {type === 'saving' ? (
              <>
                <div className="animate-in slide-in-from-left-4 duration-300">
                  <label className="block text-[10px] font-black text-blue-400 uppercase tracking-widest mb-2 px-1">Asal Wallet (Sumber)</label>
        ...
        >
          {loading ? (
            ...
            <span className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.2em]">
              {editData ? 'Perbarui Data' : type === 'saving' ? 'Simpan Tabungan' : 'Simpan Data'}
