            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-blue-600 text-white text-xs font-black uppercase tracking-wider rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20"
                >
                  + Tambah Wallet
                </button>
              </div>
                  ...
                  <div className="grid grid-cols-5 gap-2">
                    {ICON_OPTIONS.map((icon) => (
                      <button
                        ...
                        className={`p-3 rounded-xl border text-2xl transition-all ${
                          formData.icon === icon
                            ? 'bg-blue-600 border-blue-600 scale-110'
                            : isDark ? 'bg-slate-800 border-white/10 hover:border-blue-500' : 'bg-white border-slate-200 hover:border-blue-500'
                        }`}
                      >
                        {icon}
                      </button>
